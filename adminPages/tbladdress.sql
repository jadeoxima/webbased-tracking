...
INSERT INTO `tbladdress` (`id`, `brgy`, `purok`, `city`, `province`) VALUES
(2, 'timugan', 'purok1', 'los banos', 'laguna'),
(4, 'timugan', 'purok1', 'los banos', 'laguna'),
(5, 'timugan', 'purok3', 'los banos', 'laguna'),
(6, 'timugan', 'purok4', 'calamba', 'laguna'),
(7, 'anos', 'purok11', 'calamba', 'laguna');
