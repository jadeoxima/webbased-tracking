...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Truck Details | Direct Operations</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../adminPages/admin_homepage.php">Home</a></li>
              <li class="breadcrumb-item active">Truck Details | Direct Operations</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <tbody>
              <form id="details" name="details" method="POST" action="" onSubmit="return false;">
                  <tr>
                    ...
                    <td>
                      <button type="submit" id="addDetailsDirectOp" name="addDetailsDirectOp" class="btn btn-primary">Add</button>
                    </td>
                  </tr>   
              </form>              
            </tbody>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody id="output">
                  <?php
                    $sql = "SELECT truckType, vanType, plateNo, model, drivername FROM truckdetailsdirectoperation";
  ...
  <div class="modal fade" id="update_details">
    ...
    <script src="addDetailsDirectOp.js"></script>
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
    <script>
        $('#addDetailsDirectOp').click(function() {
        $.ajax({
            type: 'POST',
