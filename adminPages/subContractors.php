...
<head>
  ...
  <title>Sub-Contractors | CLM</title>
...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sub-Contractors</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form id="formExp" method="POST" action="" onSubmit="return false;">
                <div>
                    ...
                    <div class="card-footer" style="background-color: #007BFF;">
                      <h4 style="color: #FFFFFF;" align="center">Sub Contractors</h4>
                    </div>
                      <div class="row">
                        <div class="card-body">
                          ...
                          <select class="form-control" id="plateNo" style="width: 100%;">
                            <?php
                              ...
                              $sql = "SELECT plateNo FROM truckdetailssuboperation";
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" id="submitSubCont" name="submitSubCont">Submit</button>
                </div>
              </form>
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody id="output">
                  <?php
                    $sql = "SELECT * FROM tblsuboperation";
                    $result = $link-> query($sql);
                   ...
                   if($result->num_rows > 0) {
                      while($row = $result-> fetch_assoc()) {
                        echo "<tr align='center'>" . 
                            ...
                            "<a class='btn btn-primary' href='subContDel.php?id=$row[id]'>Delete</a>";
                      }
                   }    
                  ?>        
  ...
  <!-- /.content-wrapper -->
    ...
    <script src="subCont.js"></script>
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
        <script>
            

            $('#submitSubCont').click(function() {
            $.ajax({
                type: 'POST',
                url: 'outSubCont.php',
                data: { id: $('#id').val(), 
