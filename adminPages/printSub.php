...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" onclick="window.print()" role="button">
        ...
        <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-striped">
                  <thead>
                  <tr align="center">
                    <h3>Sub Contractors Monthly Summary</h3>
                    <th>Plate Number</th>
                    <th>From</th>
                    <th>To</th>
                    <th>Beginning</th>
                  ...
                  <?php
                    ...
                    $sql = "SELECT *, SUM(accomodation + meals + tollFee + telephone + others) AS travelExp,
                                   SUM(gas) AS autoExp,
                                   SUM(photocopy + others) AS misc
                            FROM tblsuboperation GROUP BY plateNo";
